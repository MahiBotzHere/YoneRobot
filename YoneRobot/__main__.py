...
PM_START_TEXT = """
`𝙃𝙖𝙞` [😍](https://telegra.ph/file/b007318e7b0015956f963.jpg) `𝙈𝙮 𝙉𝙖𝙢𝙚 𝙄𝙨 ✨` *🇨𝗔𝗧 🇬𝗜𝗥𝗟✨*
`𝙞𝙢 𝙃𝙚𝙧𝙚 𝙏𝙤 𝙃𝙚𝙡𝙥 𝙔𝙤𝙪 𝙈𝙖𝙣𝙖𝙜𝙚 𝙔𝙤𝙪𝙧 𝙂𝙧𝙤𝙪𝙥𝙨 !! 𝙃𝙞𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨 🔥` *ℂ𝕆𝕄𝕄𝔸ℕ𝔻𝕊🔶*   
"""

buttons = [
    [
        InlineKeyboardButton(
            text="🔅𝗔𝗗𝗗 𝗠𝗘 𝗧𝗢 𝗚𝗥𝗢𝗨𝗣🔅", url="t.me/Cat_Girlbot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="𝔸𝕓𝕠𝕦𝕥 🔶", callback_data="yone_"),
        InlineKeyboardButton(text="ℂ𝕆𝕄𝕄𝔸ℕ𝔻𝕊🔶", callback_data="help_back"),
    ],
    [
        InlineKeyboardButton(
...
HELP_STRINGS = """
`Hi.. I'm` [🇨𝗔𝗧 🇬𝗜𝗥𝗟✨](https://telegra.ph/file/94a452ed62377697e7bd1.jpg)
`Click on the buttons below to get documentation about specific modules..`"""


yone_IMG = "https://telegra.ph/file/b007318e7b0015956f963.jpg"
